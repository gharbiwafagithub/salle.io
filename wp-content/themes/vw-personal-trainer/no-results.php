...
<h2 class="entry-title"><?php esc_html_e( 'Nothing Found', 'vw-personal-trainer' ); ?></h2>
...
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	...
	<div class="error-btn">
		<a class="view-more" href="<?php echo esc_url(home_url() ); ?>"><?php esc_html_e( 'Back to Home Page', 'vw-personal-trainer' ); ?><i class="fa fa-angle-right"></i><span class="screen-reader-text"><?php esc_html_e( 'Back to Home Page','vw-personal-trainer' );?></span></a>
	</div>
<?php endif; ?>